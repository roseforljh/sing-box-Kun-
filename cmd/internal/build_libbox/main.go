...
func init() {
	...
	sharedTags = append(sharedTags, "with_gvisor", "with_quic", "with_wireguard", "with_utls", "with_clash_api") // KunBox: removed with_conntrack
...
func buildAndroid() {
	...
	tags := sharedTags // KunBox: removed tailscale for smaller binary
	if debugEnabled {
